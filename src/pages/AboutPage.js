...
function AboutPage(props){
    return(
        <div>
            ...
            <Content>
                <p>Hi there, my name is Simon. I am a full-stack developer who have experience in ReactJs, Redux, MongoDB, ExpresJs, NodeJs, Bootstrap, and MaterialUI. </p>
                ...
                <p>My vision is to convert the skills that I have to bring the fascinating ideas with the most potential in improving our society to live.</p>
